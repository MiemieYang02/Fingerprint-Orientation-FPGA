...
exec xvlog -sv {*}$rtl_files fingerprint_direction_fpga/fingerprint_direction_fpga.srcs/sim_1/new/tb_fpga_orientation_pipeline.v
exec xelab tb_fpga_orientation_pipeline -s tb_fpga_orientation_pipeline_sim
exec xsim tb_fpga_orientation_pipeline_sim -runall
